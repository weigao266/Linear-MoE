...
input_data_dir=/cpfs01/user/sunweigao/my/data-SlimPajama/SlimPajama-627B-train-split.json
tokenizer=Qwen2Tokenizer
json_keys=text
output_data_dir=/cpfs01/user/sunweigao/my/data-SlimPajama/slimpajama_megatron_bin_data
